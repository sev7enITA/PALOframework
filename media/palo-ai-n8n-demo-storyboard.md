...
**Format:** 16:9, 1920x1080, English narration, captions burned in or supplied as SRT.
...
|---|---|---|---|
| 00:00-00:13 | Title card over the PALO-AI two-way n8n architecture hero. Slow zoom from an agent node toward the governance boundary. | **PALO-AI + n8n**  Governance for agent authority, policy, oversight and evidence  **Developer preview | v2.4.1** | 'AI agents can choose operational tools. But autonomy is not authority. PALO-AI makes authority, policy, oversight and evidence visible.' |
...
- Export H.264/AAC at 1920x1080, constant frame rate, exactly 03:00. Deliver `palo-ai-n8n-demo-captions.srt` alongside the video and check caption timing after export.
