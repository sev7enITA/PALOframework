const semanticPreview = (record) => ({
  ...record,
  definitionVersion: "3.0.0",
  dataClass: "illustrative-local-preview",
  authorityBoundary: "Local demonstration data; not a source of record, live authority, or approval decision.",
  sourceRefs: [],
});
