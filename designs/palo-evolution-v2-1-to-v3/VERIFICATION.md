...
- 1440 x 900: centered 16:9 canvas, current-release state
- 1920 x 1080: full-canvas final state after autoplay
- 390 x 844: stacked mobile current-release state
- 360 x 800: stacked mobile final state
...
- Mobile controls remain fixed at the viewport bottom, show synchronized progress, and measure at least 44 x 44 CSS pixels.
- At 390 x 844, autoplay beats 3-6 were fully visible with the active card above the 67px fixed control bar; manual Previous was also tested after scrolling to the document bottom.
...
- `assets/palo-evolution-slide-desktop.png` - 1440 x 900, beat 4
- `assets/palo-evolution-slide-mobile.png` - 390 x 844, oriented beat 4 with persistent controls
- `assets/palo-evolution-slide-final.png` - 1920 x 1080, beat 6
