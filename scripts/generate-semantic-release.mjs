...
const releaseItems = [
  ...
  ["external-evidence-provider-registry", "data/external-evidence/provider-registry.json", "provider-registry", "schemas/palo-external-evidence-provider-registry.schema.json"],
  ["agentic-capability-crosswalk", "data/external-evidence/palo-agentic-capability-crosswalk.json", "crosswalk-registry", "schemas/palo-agentic-capability-crosswalk.schema.json"],
  ...
  ["external-evidence-provider-registry-schema", "schemas/palo-external-evidence-provider-registry.schema.json", "schema", null],
  ["external-agentic-evidence-schema", "schemas/palo-external-agentic-evidence.schema.json", "schema", null],
  ["agentic-capability-crosswalk-schema", "schemas/palo-agentic-capability-crosswalk.schema.json", "schema", null],
